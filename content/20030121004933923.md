...
- Activar las opciones y dependecias en tiempo compilación justas para nuestras
  necesidades.
...
- checksum: utiliando md5sum asegura que los archivos descargados coinciden con
...
- configure: configura el paquete de la manera especificada en el *Makefile*.
  Normamente se hace a través de sistemas de configuración como
