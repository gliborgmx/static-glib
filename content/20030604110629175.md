...
[aquí](http://www.nvidia.com/content/drivers/drivers.asp)
...
del modo gráfico. Si cuando inicias linux automáticamente entras en modo
gráfico tendrás que hacer una modificación a tu archivo "inittab" que es
...
Si estas entrando en modo gráfico automáticamente tendrás en la parte
...
con el sistema X window que es el modo gráfico de linux. Tendrás que
...
linux en modo gráfico, escribe en el prompt `startx` para comenzar tu
...
Una vez en el modo gráfico puedes volver a restaurar tu archivo
"inittab" de modo que puedas entrar en modo gráfico cada vez que inicies
linux (recuerda cambiar el 3 por el 5)

¡Disfruta de tu tarjeta NVIDIA en Linux!
