...
Así que la forma en que trabajé (y aun trabajo) es simplemente
preocupándome por el "hoy". No grandes expectativas, sólo haciendo lo
...
importa lo que hago, así que por simplicidad terminé usando una única
...
No se si eso cuente como "gadget", pero ando tras la Canon 5D (es una
...
Will: Virtualización es todo un buzz en la computación hoy. Con
...
(<http://shitabout.wordpress.com/2006/06/21/cual-distro-usa-linux-torvalds/>)
