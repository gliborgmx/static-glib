...
de sus Turbos los compiladores más usados del mundo y los mejores que uno podía
encontrar para hacer algo decente en los años 80´s - 90´s para DOS/Windows (En
...
creador de este compilador Turbo C fue Robert Jervis, el cual siempre fue más
eficiente para generar código que su contra parte *Microsoft C*.

Borland mantiene una página web dedicada a estos antiguos compiladores llamada
[Museum](http://community.borland.com/museum) donde con simplemente registrarte
te puedes descargar los antiquísimos y preciados Turbo Pascal 1.0 al 5.5, Turbo
C 1.0 al 2.01 y Turbo C++ 1.0 (la versión Turbo Pascal 7.0 solo esta disponible
en Francia por el momento)

Tan famosos fueron los "Turbo" que existieron algunos cómic llamados
[Turbo Man](http://community.borland.com/article/0,1410,20297,00.html)
...
Enlace relacionado:
[artículo](http://www.disc.ua.es/~gil/miscelánea/artículos.html)
