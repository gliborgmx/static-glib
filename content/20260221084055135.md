...
generativa. Uno de los proyectos que más controversia ha generado,
...
allá de comandos simples (como Siri o Alexa). Integra agentes de IA y utiliza el
contexto del usuario (como datos personales, interacciones previas, ubicación,
conocimiento organizacional) para ofrecer soporte personalizado.

Podemos definirlo como un **bot personal de mensajería instantánea**, cuya
función es servir de interfaz para uno o varios agentes de IA que operan en
...
para que el asistente opere sobre el mundo real. La naturaleza humana de
sobrepasar todos los límites sin considerar los problemas que pueden ocasionar.
...
- Casos concretos:
  ...
  - Otros, más osados, ha instruido a sus bots para que inviertan dinero en la
    bolsa a su libre albedrío, o apuesten en
    [Polymarket](https://polymarket.com/), perdiendo dinero la más de las veces.

## Conclusión

Yo no voy a usar Moltbot, al menos a corto plazo. Aunque utilizo agentes con IA
para programar (como Aider, del que ya hablé), todo esto me hace pensar que para
usarlos debe ser dentro *sandboxes*, con permisos de ejecución explícitos para
las herramientas que únicamente pueden usar, donde las fuentes de información
también estén controladas.
