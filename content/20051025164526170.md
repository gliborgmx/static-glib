...
## Requerimientos físicos previos
...
- Java JDK, Standard Edition (J2SE), descárguenlo de
...
# rm jdk-1_5_0_05-linux-i586-rpm.bin jdk-1_5_0_05-linux-i586-rpm
```
...
su
# cp j3d-140-build6-linux-x86.zip /usr/java/jdk1.5.0_05/jre/
# cd /usr/java/jdk1.5.0_05/jre/
# unzip j3d-140-build6-linux-x86.zip
# rm j3d-140-build6-linux-x86.zip
```
...
```console
su
# mv jai-1_1_2-lib-linux-i586-jdk.bin /usr/java/jdk1.5.0_05/
# cd /usr/java/jdk1.5.0_05/
# chmod +x jai-1_1_2-lib-linux-i586-jdk.bin
# ./jai-1_1_2-lib-linux-i586-jdk.bin
# rm jai-1_1_2-lib-linux-i586-jdk.bin
```
...
Deben ver una ventana con el LG3D corriendo, en caso de que no puedan establecer
una conexión TCP en su manejador de escritorio hay que agregar:.
...
de lo último en equipo, apenas pude usarlo en modo lg3d-dev y mejora como
...
mientras ni MS-Windows Vista está tan espectacular. Por mientras vayan
