...
consecuencia a tormentas eléctricas, hice esta pequeña guía para este
...
```console
wget http://cran.r-project.org/src/base/R-2/R-2.3.1.tar.gz
tar> zxvf R-.2.3.1.tar.gzcd R-2.3.1`
```
...
análisis de expresión en micro-arreglos
