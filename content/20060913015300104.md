...
Acabo de bajar la distro freespire 1.0 de 650 MB (una proeza para mi
conexión). Para quien quiera una copia sólo venga a mi con un CD virgen,
descárguelo de <http://www.freespire.org> o
...
raro en Internet. Es para PCs, la tengo funcionando en el cyber junto
con un Ubuntu. Aún no pongo la impresora en red, ya que la tiene en un
OS XP, bueno eso ya es aparte.

Si la quieren antes, pueden bajarla o pueden venir a mi cyber en
Salamanca, en el Bulevar Las Reinas junto a la panadería Manolo, el
cyber es "Cibersalmantina" no recuerdo el número. Sale chavos.
...
video, inalámbricas, etcétera). Como antecedentes, está basada en
...
Observación: Editores antes de subir una noticia, revisen la gramática.
