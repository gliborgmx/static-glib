...
Facturación, Contabilidad, Bancos, CXP, CXC, Compras.
...
descomprimes como root el `clip-prg-1.1.6-1.tgz`
...
Ahora vamos a descomprimir el sluzlibre y crear la base de datos, esto
...
La clave con la que des de alta una empresa debe de ser igual al nombre de la
base de datos con la que se creo: 'sluz'. Esto es muy importante.
